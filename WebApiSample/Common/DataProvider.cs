...
namespace WpfClientTest.Common
{
    public class DataProvider
    {
        //connection string kết nối DB server
        public string connectionStr = $"Data Source=server210;Database=WebSampleV2;UID=wsamadmv2;Password=$201609W3B2@MpL3@fVn@2020; Min Pool Size=0;Max Pool Size=1000;Pooling=true; Connect Timeout=65535;";
        //$"Data Source={RecycledManagement.Properties.Settings.Default.serverName};Database={RecycledManagement.Properties.Settings.Default.dbName}" +
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public int ExecuteNonQuery_GetIdIdentity(string query, object[] parametter = null, [CallerMemberName] string memberCall = "", [CallerFilePath] string memberClass = "", [CallerLineNumber] int memberLine = 0)
        {
            int result = 0;
        ...
        public int ExecuteSqlTransaction(List<SqlTransactionQueryList> listQuery, [CallerMemberName] string memberCall = "", [CallerFilePath] string memberClass = "", [CallerLineNumber] int memberLine = 0)
        {
            int result = 0;
